...
export default class Game extends Component {
  constructor(props) {
    ...
    this.state = {
      board: [EMPTY, EMPTY, EMPTY, EMPTY, EMPTY, EMPTY, EMPTY, EMPTY, EMPTY,EMPTY, EMPTY, EMPTY, EMPTY, EMPTY, EMPTY, EMPTY, EMPTY, EMPTY, EMPTY, EMPTY, EMPTY, EMPTY, EMPTY, EMPTY],
    };
  }
  ...
  render() {
    return (
      <View>
        <Board currentSquareWidth={this.props.currentSquareWidth} board={this.state.board} onPress={this._handlePress} />
      </View>
    );
  }
}
